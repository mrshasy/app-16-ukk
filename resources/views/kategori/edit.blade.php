                    ...
                    <div class="card-body">
                        <form action="{{ route('kategoris.update', ['id_kategori' => $kategori->id_kategori]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                ...
                                <input type="text" class="form-control form-control-xl @error('nama_kategori') is-invalid @enderror" placeholder="Nama Kategori" name="nama_kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}">
                            </div>
